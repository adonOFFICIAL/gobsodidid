...
const starts = async (Ramdani = new WAConnection()) => {
	...
	Ramdani.browserDescription = ["ADON Official", "Chrome", "3.0.0"];
	...
	Ramdani.on('connecting', () => {
		console.log(color('[ adon Official ]', 'yellow'), color('PROSES NYAMBUNG...'));
	})
const spinner = { 
  "interval": 120,
  "frames": [
	...
	//connect
	Ramdani.on('open', () => {
		console.log(color('[HC]', 'white'), color('UDAH TERHUBUNG ADONGANTENG'));
	})
