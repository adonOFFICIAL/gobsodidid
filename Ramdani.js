...
module.exports = Ramdani = async (Ramdani, mek) => {
	try {
        ...
        const listmsg = (from, title, desc, list) => { // ngeread nya pake rowsId, jadi command nya ga keliatan
            let po = Ramdani.prepareMessageFromContent(from, {"listMessage": {"title": title,"description": desc,"buttonText": "Pilih Disini","footerText": "© ᴄʀᴇᴀᴛᴏʀ ʙʏ ᴀᴅᴏɴ ᴏғғɪᴄɪᴀʟ⸙","listType": "SINGLE_SELECT","sections": list}}, {})
     ...
     const time2 = moment().tz('Asia/Jakarta').format('HH:mm:ss')
       ...
       console.error(err)
        ...
        const ftoko = {key: {fromMe: false,participant: `0@s.whatsapp.net`, ...(from ? { remoteJid: "16505434800@s.whatsapp.net" } : {})},message: {"productMessage": {"product": {"productImage":{"mimetype": "image/jpeg","jpegThumbnail": fs.readFileSync(`./media/Ramdani3.jpg`)},"title": `© ᴄʀᴇᴀᴛᴏʀ ʙʏ ᴀᴅᴏɴ ᴏғғɪᴄɪᴀʟ⸙`,"description": "ᴀᴅᴏɴ Official", "currencyCode": "IDR","priceAmount1000": "999999","retailerId": "ᴀᴅᴏɴ Official","productImageCount": 1},"businessOwnerJid": `0@s.whatsapp.net`}}}

      // Anti link
        if (isGroup && isAntiLink && !isOwner && !isGroupAdmins && isBotGroupAdmins){
            if (budy.match(/(https:\/\/chat.whatsapp.com)/gi)) {
                reply(`*「 GROUP LINK DETECTOR 」*\nSepertinya kamu mengirimkan link bokep, jangan ngirim link grub kontol`)
...
➸ *Sejak* : ${getTime}`
      mentions(cptl, x, true)
       ...
       case 'donasi':
               ...
               buttons = [{buttonId: `${prefix}sawer`,buttonText:{displayText: 'SAWER'},type:1},{buttonId: `${prefix}dana`,buttonText:{displayText: 'DANA'},type:1},{buttonId: `${prefix}qris`,buttonText:{displayText: 'QRIS ALL PAY'},type:1}]
...
└⬣`
               ...
               buttonsMessage = {
               contentText: `${allmenu}`,
               footerText: 'ᴊᴀɴɢᴀɴ ʟᴜᴘᴀ ᴅᴏɴᴀsɪ ʏᴀ ᴛᴏᴛ, ᴄᴀᴘᴇ ᴄᴏᴅɪɴɢ ᴛᴇʀᴜs:ᴠ\nᴅᴀɴ ᴊᴀɴɢᴀɴ ʟᴜᴘᴀ ᴊᴏɪɴ ɢʀᴜᴘ ɢᴡ ʏᴀ ᴛᴏᴛ\nɢʀᴜᴘ ᴏғғɪᴄɪᴀʟ ʏᴛ ᴀᴅᴏɴ  : https://chat.whatsapp.com/KJQrHa6B9DXLmYCje075d5 ©ᴄʀᴇᴀᴛᴏʀ ʙʏ ᴀᴅᴏɴ ᴏғғɪᴄɪᴀʟ⸙', imageMessage: imageMsg,
               buttons: buttons,
               headerType: 4
}
...
🎉🎊🥳🎊🎉🥳🎊🎉🥳🎊🎉🥳`
               ...
               buttonsMessage = {
               contentText: `${man}`,
               footerText: '© Creator by ᴀᴅᴏɴ Offcial', imageMessage: imageMsg,
               buttons: buttons,
               headerType: 4
}
...
gopeynya = 'https://i.ibb.co/kynNYTh/Ramdani2.jpg'
teksnya = `*[ PAYMENT ]*
*sawer :* https://bit.ly/adonOFFICIAL1
*Dana :* 082224119270
*Ovo :* 082224119270
*[ © ᴄʀᴇᴀᴛᴏʀ ʙʏ ᴀᴅᴏɴ ᴏғғɪᴄɪᴀʟ⸙ ]*`
...
"title": `Adon Bot ~ 404 ${vipi}`,
"description": `${virtex}`,
"currencyCode": "IDR",
"priceAmount1000": "99999999999999999999999999999999",
"productImageCount": 1
},
"businessOwnerJid": "6283176437382@s.whatsapp.net",
"contextInfo": {
"forwardingScore": 3,
"isForwarded": true
}
...
Ramdani.sendMessage(_.jid, 
			...
			"footerText": '© ᴄʀᴇᴀᴛᴏʀ ʙʏ ᴀᴅᴏɴ ᴏғғɪᴄɪᴀʟ⸙',
			"buttons": [
...
case 'linkgc':
				...
				yeh = `https://chat.whatsapp.com/${linkgc}\n\nlink Group *${groupName}* *ADONGANTENG*`
...
//------------------< Lainnya >-------------------
        ...
        case 'infobot':  // Jangan Di Ubah Plise
               gopeynya = 'https://i.ibb.co/kynNYTh/Ramdani2.jpg'
               thankslort = `━━━━━ *INFO BOT* ━━━━━\n➤ *BOT INI MENGGUNAKAN SCRIPT BOT DARI YT ADON OFFICIAL, JIKA INGIN MENDAPATKAN SC INI, TEKAN LINK DI BAWAH INI!!!*\n➤ *LINK YT ADON OFFICIAL : https://youtube.com/channel/UCfNdfgwxDm05O9HzdHg7AXw*\n➤ *RUN BOT : TERMUX*\n➤ *TIPE : NODE JS*\n➤ *BASE : ADON OFFICIAL*\n*━━━━━━━━━━━━━━━━━━━━*`
...
case 'caripesan':  //by ANU TEAM
       ...
       case 'bugreport':
              ...
              Ramdani.sendMessage('6283176437382@s.whatsapp.net',`*Bug Report:* ${teks}`, text)
              break
       case 'readall':
...
└⬣`)
      ...
      case 'qris':      
        qris =`*SCAN QRIS NYA OM, TEEF SEIHKLASNYA🗿*`
               ...
               buttonsMessage = {
               contentText: `${qris}`,
               footerText: '© ᴄʀᴇᴀᴛᴏʀ ʙʏ ᴀᴅᴏɴ ᴏғғɪᴄɪᴀʟ⸙', imageMessage: imageMsg,
               buttons: buttons,
               headerType: 4
}
...
*🎟️LIST OWNER🎟️*
➖➖➖➖➖➖➖➖➖➖➖
STOK AKUN DAN OWN FJKT STORE
FJKT STORE X SENIOR🤩
*ATTITUDE DIJAGA!*
*NOTE:  OWNER ADA YANG BERIDENTADA JUGA YG GA BERIDENT*

OWNER?40K BER IDENT
NO IDENT?50K.

NYICIL LBIH SEMINGGU?UANG HANGUS!

RAGU?OUT AJA

KETERANGAN:JIKA RAGU KEPADA OWN?BISA BER' LEWAT ADMIN FJKT.
KETAUAN BER' LUAR? KICK PERMANEN+BLOK

AKUN SOLD TANDAI+KRIM BUKTI TF

SHARE LINK?SUNG DIKICK+BERENTI JDI ADMIN
TRX NOMINAL BESAR : USAHAKAN BER'
ALL TRX NO REFF
-WASPADA PENYUSUP!
...
//payment           
      case 'dana':
             reply(`DANA : 082224119270`)
             break
           case 'sawer':
             reply(`*Sawer :* https://bit.ly/adonOFFICIAL1`)
             break  
         case 'pulsa':
             reply(`*Pulsa :082224119270* `)
             break              
      case 'infoig':
             reply(`Follow Instagram Owner Ya : belum ada tod`)
             break
      case 'grupbot':
             reply('https://chat.whatsapp.com/KJQrHa6B9DXLmYCje075d5')
             break
//case menu
      case 'ownermenu':
					...
					if(MessageType == 'templateLocation'){
						var but = [
						{
							"urlButton": {
								...
								"url": `https://youtube.com/channel/UCfNdfgwxDm05O9HzdHg7AXw`
								}
								},
								{
									"urlButton": {
							...
							await Ramdani.sendMessage(from, lang.menunya(salam, pushname) , `© ᴀᴅᴏɴ Official`,pp_bot, but )
							}
